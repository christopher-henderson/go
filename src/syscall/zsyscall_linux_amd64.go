...
func _accept(s int, rsa *RawSockaddrAny, addrlen *_Socklen) (fd int, err error) {
...
func _accept4(s int, rsa *RawSockaddrAny, addrlen *_Socklen, flags int) (fd int, err error) {
